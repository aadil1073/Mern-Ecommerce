...
const LoginSignUp = ({login, signup}) => {
    ...
    <div>
      <a href="/" class="logo">
        <h1 class="text-center">ElectroHub</h1>
      </a>        
    </div>
    <div class="d-flex justify-content-center">
        ...
        {showLogin ?<div class="login-box m-auto mt-5 col-4">
            ...
            <form class="needs-validation" novalidate="" action="" onSubmit={e=>{e.preventDefault();validateLogin(user)}}>
              ...
              <div>
                ...
                <input type="password" class="form-control" placeholder="password" value={user.password} onChange={e=>setUser({...user,password:e.target.value})}/>
                <div class="invalid-feedback">
        ...
        {!showLogin ?<div class="login-box m-auto mt-5 col-4">
              ...
              <form class="needs-validation" novalidate="" action=""  onSubmit={e=>{e.preventDefault();validateSignup(user)}}>
                ...
                <div>
                  <label for="password" class="form-label">Password</label>
                  <input type="password" class="form-control" placeholder="password" value={user.password} onChange={e=>setUser({...user,password:e.target.value})} minlength="6"/>
                  <div class="invalid-feedback">
                    Valid Password required (min 6 chars)
                  </div>
                </div>
