...
const CheckOut = ({order, user, addAddress,setShipAddress,placeOrder}) => {
  const blank_address = {first_name: '',last_name: '',phone: '', address1: '', address2: '', country: '', state: '', pincode: ''};
  const [address, setAddress] = useState(blank_address);


  const validateAddress = (address) => {
    if(!address.first_name || !address.last_name || !address.phone || !address.address1 || !address.country || !address.state || !address.state ) {
          ...
          <div className="row g-3">
            <div className="col-md-5 col-lg-4 order-md-last">
              ...
              {order.shipping_address?<div className="card">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted ">{order.shipping_address.address1}, {order.shipping_address.address2}, {order.shipping_address.state}, {order.shipping_address.country},{order.shipping_address.pincode}</h6>
            ...
            <div className="col-md-7 col-lg-8">
              ...
              <div className="card-body">
                ...
                <h6 className="card-subtitle mb-2 text-muted ">{address.address1}, {address.address2}, {address.state}, {address.country},{address.pincode}</h6>
              ...
              <form className="needs-validation" novalidate="" onSubmit={(e)=>{e.preventDefault(); validateAddress(address)}}>
                <div className="row g-3">
                  <div className="col-sm-6">
                    ...
                    <input type="text" className="form-control" id="firstName" placeholder="" required="" value={address.first_name} onChange={e=>setAddress({...address, first_name:e.target.value})}/>
                  ...
                  <div className="col-md-3">
                    ...
                    <input type="text" className="form-control" id="zip" placeholder="" value={address.pincode} onChange={e=>setAddress({...address, pincode:e.target.value})}/>
                    <div className="invalid-feedback">
                      Zip code required.
                    </div>
                  </div>
